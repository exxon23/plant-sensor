...
router.post('/', async (req, res) => {
  try {
    ...
    await axios.post(`https://api.thingspeak.com/update?api_key=${thingSpeakWriteKey}&field1=${temperature.value}&field2=${humidity.value}&field3=${moisture.value}&field4=${lightIntensity.value}`)
